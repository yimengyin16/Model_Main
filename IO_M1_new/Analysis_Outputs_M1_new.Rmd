...
draw_quantiles(c(paste0(prefix, runs_M1F11)), "FR_MA", ylim = c(0, 250), year.max = 60)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1F11)), "C_PR", ylim = c(-2, 35),  year.max = 60)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1F11)), "ERC_PR", ylim = c(-2, 35),year.max = 60)$plot %>% print
