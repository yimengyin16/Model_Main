...
expand_apply(c(NA,1:10), mean, na.rm = TRUE)
...
#p2
 ...
 #  p4
  ...
  ggsave(paste0(IO_folder, "/graphs/g_", simnum, ".png"), ml, width=13, height=10, units="in")     

  return(ml)
}

apply(as.matrix(sim_select1), 1, gpanel.yy)
apply(as.matrix(sim_select2), 1, gpanel.yy)
