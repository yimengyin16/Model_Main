...
results_all %>% filter(runname == "A1F075_O15d", year == 1, sim == 1) %>% select(one_of(var.display))
...
draw_quantiles(c(paste0(prefix, runs_M1_F11)), "FR_MA", ylim = c(0, 250), year.max = 40)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1_F11)), "C_PR", ylim = c(-2, 35),  year.max = 40)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1_F11)), "ERC_PR", ylim = c(-2, 35),year.max = 40)$plot %>% print
...
draw_quantiles(c(paste0(prefix, runs_M1_soa)), "C_PR", ylim = c(-2, 35),  year.max = 60)$plot %>% print
draw_quantiles(c(paste0(prefix, runs_M1_soa)), "ERC_PR", ylim = c(-2, 35),year.max = 60)$plot %>% print
...
draw_quantiles(c(paste0(prefix, runs_M1_shock)), "FR_MA", ylim = c(0, 250), year.max = 20)$plot %>% print
...
draw_quantiles(paste0(prefix, c("3a", "6a", "7a")), "FR", ylim = c(0, 125),     year.max = 20)$plot +
  labs(y = "%", title = "Quantile Plots of Funded Ratio(Based on Market Asset Value)")
  draw_quantiles(paste0(prefix, c("3a", "6a", "7a")), "FR_MA", ylim = c(0, 125),  year.max = 20)$plot %>% print
draw_quantiles(paste0(prefix, c("3a", "6a", "7a")), "C_PR", ylim = c(-2, 20),   year.max = 20)$plot +
...
prefix <- "B2F075_"
draw_quantiles(paste0(prefix, c(0, 1, 2, 3)), "FR_MA", ylim = c(0, 250))$plot + 
   labs(y = "%", title = "Quantile Plots of Funded Ratio Based on Market Asset Value")
draw_quantiles(paste0(prefix, c(0, 1, 2, 3)), "C_PR", ylim = c(-2, 35))$plot + 
...
prefix <- "B1F075_"
draw_quantiles(paste0(prefix, c(0, 1)), "FR_MA", ylim = c(0, 250))$plot +
   labs(y = "%", title = "Quantile Plots of Funded Ratio(Based on Market Asset Value)")
draw_quantiles(paste0(prefix, c(0, 1)), "C_PR", ylim = c(-2, 35))$plot +
   labs(y = "%", title = "Quantile Plots of Total Total Contribution Rate")
draw_quantiles(paste0(prefix, c(0, 1)), "ERC_PR", ylim = c(-2, 35))$plot 
